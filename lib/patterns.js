...
// The version part is intentionally loose: it may be an exact version, "latest",
// or an npm-style semver range ("^2.0.0", "1.2.3 - 2.0.0", ">=1.0.0 <2.0.0").
// The range grammar itself is validated by the dependency-version rule.
export const DEPENDENCY_FORMAT = /^[a-z0-9][a-z0-9-]*\/[a-z0-9][a-z0-9-]*(@[^@]*)?$/;
...
//   __callerPackage - immediate package identity for a nested aux4 command
